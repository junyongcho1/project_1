...
class CurrencyExchange with ChangeNotifier {
  ...
  String resultCurrency = 'USD'; //'SEK';//'USD';
  /*                    'GBP',
                        'USD',
                        'AUD',
                        'CAD',
  ...
  //riEzGzvSeCepecdoaPyNoujyJ51sWoGU
//https://www.koreaexim.go.kr/site/program/financial/exchangeJSON?authkey=$APIKEY&searchdate=&data=AP01  riEzGzvSeCepecdoaPyNoujyJ51sWoGU
  Future<List<CurrencyObj>> getCurrencies() async {
    ...
    String? APIKEY = 'riEzGzvSeCepecdoaPyNoujyJ51sWoGU';
    
    Uri url = Uri.parse(
        'https://www.koreaexim.go.kr/site/program/financial/exchangeJSON?authkey=$APIKEY&searchdate=20221108&data=AP01');
